...
export default function BirthdayQuote() {
  ...
  return (
    <SectionWrapper id="quote" badge="✨ Inspiration" title="Birthday Quote Generator" subtitle="Press for a dose of happiness" variant="alt">
      <div className="flex flex-col items-center gap-6">
        ...
        {quote && (
          <motion.blockquote
            className="premium-card glow-card max-w-lg p-10 text-center font-display text-xl italic"
