...
export default function GiftBox() {
  ...
  return (
    <SectionWrapper id="gift" badge="🎁 Surprise" title="Your Special Gift" subtitle="Something wonderful awaits" variant="glow">
      <div className="flex flex-col items-center">
        <AnimatePresence mode="wait">
          {!opened ? (
            ...
            <motion.div
              key="message"
              className="premium-card max-w-lg rounded-3xl p-10 text-center"
