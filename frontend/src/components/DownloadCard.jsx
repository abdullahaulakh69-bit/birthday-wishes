  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 right-5 z-50 flex items-center gap-2 rounded-full glass-card px-4 py-2.5 text-sm font-medium transition hover:scale-105 focus-visible:outline-2 focus-visible:outline-gold sm:bottom-5 sm:right-44"
